...
def test_get_all_objects():
    ...
    oauth_info = oauth_core.oauth()
    fetch_structure_baidu_client = FetchStructureBaiduCore(access_token=oauth_info.access_token,user_name="金蛛-新账户5",temp_dir="./download")
    rsp = fetch_structure_baidu_client.get_all_objects()
    print(rsp)
...
def test_cancel_download(file_id:str):
    oauth_core = BaiduOauthCore("金蛛账户中心")
    oauth_info = oauth_core.oauth()
    fetch_structure_baidu_client = FetchStructureBaiduCore(access_token=oauth_info.access_token,user_name="金蛛-新账户5",temp_dir="./downloads")
    rsp = fetch_structure_baidu_client.cancel_download(file_id)
    print(rsp)
...
def test_run():
    ...
    oauth_info = oauth_core.oauth()
    fetch_structure_baidu_client = FetchStructureBaiduCore(access_token=oauth_info.access_token,user_name="金蛛-新账户5",temp_dir="./downloads")
    rsp = fetch_structure_baidu_client.run()
    print(rsp)
...
if __name__ == '__main__':
    ...
    # test_cancel_download("963ececa16aa00faa0e05f0f127e9c03")
    test_run()
